![Now in Android](docs/images/HRK-splash.jpg "Now in Android")

<a href="https://play.google.com/store/apps/details?id=com.hrk.apps.hrkdev"><img src="https://play.google.com/intl/en_us/badges/static/images/badges/en_badge_web_generic.png" height="70"></a>

Now in Android App
==================

**Learn how this app was designed and built in the [design case study](https://goo.gle/HRK-figma), [architecture learning journey](docs/ArchitectureLearningJourney.md) and [modularization learning journey](docs/ModularizationLearningJourney.md).**
...
The app is currently in development. The `prodRelease` variant is [available on the Play Store](https://play.google.com/store/apps/details?id=com.hrk.apps.hrkdev).
...
`app-HRK-catalog` is a standalone app that displays the list of components that are stylized for
**Now in Android**.
...
For example, Now in Android has [screenshot tests](https://github.com/android/hrkdev/blob/main/app/src/testDemo/kotlin/com/google/samples/apps/hrkdev/ui/HRKAppScreenSizesScreenshotTests.kt)
to verify that the navigation is displayed correctly on different screen sizes 
([known correct screenshots](https://github.com/android/hrkdev/tree/main/app/src/testDemo/screenshots)). 
...
obtain the design files in the [Now in Android Material 3 Case Study](https://goo.gle/HRK-figma) (design assets [also available as a PDF](docs/Now-In-Android-Design-File.pdf)).
