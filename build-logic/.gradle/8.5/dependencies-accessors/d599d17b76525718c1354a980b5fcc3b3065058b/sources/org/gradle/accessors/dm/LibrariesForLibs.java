...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        public VersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: androidGradlePlugin (8.6.1)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: androidxActivity (1.9.2)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: androidxComposeBom (2024.09.00)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: androidxMacroBenchmark (1.3.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: androidxMetrics (1.0.0-beta01)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: androidxTestExt (1.2.1)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: firebaseBom (33.3.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: kotlinxCoroutines (1.9.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: ksp (2.0.20-1.0.25)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: moduleGraph (2.7.1)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
    ...
    public static class PluginAccessors extends PluginFactory {
        ...
        private final HrkdevPluginAccessors paccForHrkdevPluginAccessors = new HrkdevPluginAccessors(providers, config);
        ...
        /**
         * Returns the group of plugins at plugins.hrkdev
         */
        public HrkdevPluginAccessors getHrkdev() {
            return paccForHrkdevPluginAccessors;
        }
    ...
    public static class HrkdevPluginAccessors extends PluginFactory {
        private final HrkdevAndroidPluginAccessors paccForHrkdevAndroidPluginAccessors = new HrkdevAndroidPluginAccessors(providers, config);
        private final HrkdevJvmPluginAccessors paccForHrkdevJvmPluginAccessors = new HrkdevJvmPluginAccessors(providers, config);

        public HrkdevPluginAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

            /**
             * Creates a plugin provider for hrkdev.hilt to the plugin id 'hrkdev.hilt'
             * with no version specified
             * This plugin was declared in catalog libs.versions.toml
             */
            public Provider<PluginDependency> getHilt() { return createPlugin("hrkdev.hilt"); }

        /**
         * Returns the group of plugins at plugins.hrkdev.android
         */
        public HrkdevAndroidPluginAccessors getAndroid() {
            return paccForHrkdevAndroidPluginAccessors;
        }

        /**
         * Returns the group of plugins at plugins.hrkdev.jvm
         */
        public HrkdevJvmPluginAccessors getJvm() {
            return paccForHrkdevJvmPluginAccessors;
        }

    }

    public static class HrkdevAndroidPluginAccessors extends PluginFactory {
        private final HrkdevAndroidApplicationPluginAccessors paccForHrkdevAndroidApplicationPluginAccessors = new HrkdevAndroidApplicationPluginAccessors(providers, config);
        private final HrkdevAndroidLibraryPluginAccessors paccForHrkdevAndroidLibraryPluginAccessors = new HrkdevAndroidLibraryPluginAccessors(providers, config);

        public HrkdevAndroidPluginAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

            /**
             * Creates a plugin provider for hrkdev.android.feature to the plugin id 'hrkdev.android.feature'
             * with no version specified
             * This plugin was declared in catalog libs.versions.toml
             */
            public Provider<PluginDependency> getFeature() { return createPlugin("hrkdev.android.feature"); }

            /**
             * Creates a plugin provider for hrkdev.android.lint to the plugin id 'hrkdev.android.lint'
             * with no version specified
             * This plugin was declared in catalog libs.versions.toml
             */
            public Provider<PluginDependency> getLint() { return createPlugin("hrkdev.android.lint"); }

            /**
             * Creates a plugin provider for hrkdev.android.room to the plugin id 'hrkdev.android.room'
             * with no version specified
             * This plugin was declared in catalog libs.versions.toml
             */
            public Provider<PluginDependency> getRoom() { return createPlugin("hrkdev.android.room"); }

            /**
             * Creates a plugin provider for hrkdev.android.test to the plugin id 'hrkdev.android.test'
             * with no version specified
             * This plugin was declared in catalog libs.versions.toml
             */
            public Provider<PluginDependency> getTest() { return createPlugin("hrkdev.android.test"); }

        /**
         * Returns the group of plugins at plugins.hrkdev.android.application
         */
        public HrkdevAndroidApplicationPluginAccessors getApplication() {
            return paccForHrkdevAndroidApplicationPluginAccessors;
        }

        /**
         * Returns the group of plugins at plugins.hrkdev.android.library
         */
        public HrkdevAndroidLibraryPluginAccessors getLibrary() {
            return paccForHrkdevAndroidLibraryPluginAccessors;
        }

    }

    public static class HrkdevAndroidApplicationPluginAccessors extends PluginFactory  implements PluginNotationSupplier{

        public HrkdevAndroidApplicationPluginAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

            /**
             * Creates a plugin provider for hrkdev.android.application to the plugin id 'hrkdev.android.application'
             * with no version specified
             * This plugin was declared in catalog libs.versions.toml
             */
            public Provider<PluginDependency> asProvider() { return createPlugin("hrkdev.android.application"); }

            /**
             * Creates a plugin provider for hrkdev.android.application.compose to the plugin id 'hrkdev.android.application.compose'
             * with no version specified
             * This plugin was declared in catalog libs.versions.toml
             */
            public Provider<PluginDependency> getCompose() { return createPlugin("hrkdev.android.application.compose"); }

            /**
             * Creates a plugin provider for hrkdev.android.application.firebase to the plugin id 'hrkdev.android.application.firebase'
             * with no version specified
             * This plugin was declared in catalog libs.versions.toml
             */
            public Provider<PluginDependency> getFirebase() { return createPlugin("hrkdev.android.application.firebase"); }

            /**
             * Creates a plugin provider for hrkdev.android.application.flavors to the plugin id 'hrkdev.android.application.flavors'
             * with no version specified
             * This plugin was declared in catalog libs.versions.toml
             */
            public Provider<PluginDependency> getFlavors() { return createPlugin("hrkdev.android.application.flavors"); }

            /**
             * Creates a plugin provider for hrkdev.android.application.jacoco to the plugin id 'hrkdev.android.application.jacoco'
             * with no version specified
             * This plugin was declared in catalog libs.versions.toml
             */
            public Provider<PluginDependency> getJacoco() { return createPlugin("hrkdev.android.application.jacoco"); }

    }

    public static class HrkdevAndroidLibraryPluginAccessors extends PluginFactory  implements PluginNotationSupplier{

        public HrkdevAndroidLibraryPluginAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

            /**
             * Creates a plugin provider for hrkdev.android.library to the plugin id 'hrkdev.android.library'
             * with no version specified
             * This plugin was declared in catalog libs.versions.toml
             */
            public Provider<PluginDependency> asProvider() { return createPlugin("hrkdev.android.library"); }

            /**
             * Creates a plugin provider for hrkdev.android.library.compose to the plugin id 'hrkdev.android.library.compose'
             * with no version specified
             * This plugin was declared in catalog libs.versions.toml
             */
            public Provider<PluginDependency> getCompose() { return createPlugin("hrkdev.android.library.compose"); }

            /**
             * Creates a plugin provider for hrkdev.android.library.jacoco to the plugin id 'hrkdev.android.library.jacoco'
             * with no version specified
             * This plugin was declared in catalog libs.versions.toml
             */
            public Provider<PluginDependency> getJacoco() { return createPlugin("hrkdev.android.library.jacoco"); }

    }

    public static class HrkdevJvmPluginAccessors extends PluginFactory {

        public HrkdevJvmPluginAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

            /**
             * Creates a plugin provider for hrkdev.jvm.library to the plugin id 'hrkdev.jvm.library'
             * with no version specified
             * This plugin was declared in catalog libs.versions.toml
             */
            public Provider<PluginDependency> getLibrary() { return createPlugin("hrkdev.jvm.library"); }
