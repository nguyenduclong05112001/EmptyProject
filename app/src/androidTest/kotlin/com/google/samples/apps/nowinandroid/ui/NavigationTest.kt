...
import com.hrk.apps.hrkdev.MainActivity
import com.hrk.apps.hrkdev.R
import com.hrk.apps.hrkdev.core.model.data.Topic
import com.hrk.apps.hrkdev.core.rules.GrantPostNotificationsPermissionRule
...
import com.hrk.apps.hrkdev.feature.bookmarks.R as BookmarksR
import com.hrk.apps.hrkdev.feature.foryou.R as FeatureForyouR
import com.hrk.apps.hrkdev.feature.search.R as FeatureSearchR
import com.hrk.apps.hrkdev.feature.settings.R as SettingsR
...
//    }
    ...
    fun whenSettingsDialogDismissed_previousScreenIsDisplayed() {
        composeTestRule.apply {
            ...
            onNode(hasText(saved) and hasTestTag("HRKNavItem")).assertIsSelected()
        }
    }
