...
import com.hrk.apps.hrkdev.uitesthiltmanifest.HiltComponentActivity
...
@HiltAndroidTest
class HRKAppScreenSizesScreenshotTests {
    ...
    private fun testHRKAppScreenshotWithSize(width: Dp, height: Dp, screenshotName: String) {
        composeTestRule.setContent {
            CompositionLocalProvider(
                ...
                DeviceConfigurationOverride(
                    ...
                    HRKTheme {
                        val fakeAppState = rememberHRKAppState(
