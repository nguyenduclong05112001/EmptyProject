...
import com.hrk.apps.hrkdev.core.network.demo.DemoHRKNetworkDataSource
...
/**
 * Test double for [HRKNetworkDataSource]
 */
class TestHRKNetworkDataSource : HRKNetworkDataSource {

    private val source = DemoHRKNetworkDataSource(
