...
import com.hrk.apps.hrkdev.core.data.model.topicCrossReferences
import com.hrk.apps.hrkdev.core.data.model.topicEntityShells
import com.hrk.apps.hrkdev.core.data.testdoubles.CollectionType
import com.hrk.apps.hrkdev.core.data.testdoubles.TestNewsResourceDao
...
import com.hrk.apps.hrkdev.core.data.testdoubles.filteredInterestsIds
import com.hrk.apps.hrkdev.core.data.testdoubles.nonPresentInterestsIds
import com.hrk.apps.hrkdev.core.database.model.NewsResourceEntity
import com.hrk.apps.hrkdev.core.database.model.NewsResourceTopicCrossRef
import com.hrk.apps.hrkdev.core.database.model.PopulatedNewsResource
...
import com.hrk.apps.hrkdev.core.testing.notifications.TestNotifier
...
class OfflineFirstNewsRepositoryTest {
    ...
    fun offlineFirstNewsRepository_sync_pulls_from_network() =
        testScope.runTest {
            ...
            HRKPreferencesDataSource.setShouldHideOnboarding(false)
    ...
    fun offlineFirstNewsRepository_sync_marks_as_read_on_first_run() =
        testScope.runTest {
            ...
            assertEquals(
                ...
                HRKPreferencesDataSource.userData.first().viewedNewsResources,
            )
        }
    ...
    fun offlineFirstNewsRepository_sends_notifications_for_newly_synced_news_that_is_followed() =
        testScope.runTest {
            // User has onboarded
            HRKPreferencesDataSource.setShouldHideOnboarding(true)
            ...
            // Set followed topics
            HRKPreferencesDataSource.setFollowedTopicIds(followedTopicIds)
