...
fun HRKOutlinedButton(
    ...
    OutlinedButton(
        ...
        border = BorderStroke(
            width = HRKButtonDefaults.OutlinedButtonBorderWidth,
            color = if (enabled) {
                MaterialTheme.colorScheme.outline
            } else {
                MaterialTheme.colorScheme.onSurface.copy(
                    alpha = HRKButtonDefaults.DISABLED_OUTLINED_BUTTON_BORDER_ALPHA,
                )
            },
        ),
        contentPadding = contentPadding,
...
@ThemePreviews
@Composable
fun HRKButtonPreview() {
    HRKTheme {
        HRKBackground(modifier = Modifier.size(150.dp, 50.dp)) {
            HRKButton(onClick = {}, text = { Text("Test button") })
        }
    }
}
...
@ThemePreviews
@Composable
fun HRKOutlinedButtonPreview() {
    HRKTheme {
        HRKBackground(modifier = Modifier.size(150.dp, 50.dp)) {
            HRKOutlinedButton(onClick = {}, text = { Text("Test button") })
        }
    }
}
...
@ThemePreviews
@Composable
fun HRKButtonLeadingIconPreview() {
    HRKTheme {
        HRKBackground(modifier = Modifier.size(150.dp, 50.dp)) {
            HRKButton(
                onClick = {},
                text = { Text("Test button") },
                leadingIcon = { Icon(imageVector = HRKIcons.Add, contentDescription = null) },
            )
        }
    }
}
