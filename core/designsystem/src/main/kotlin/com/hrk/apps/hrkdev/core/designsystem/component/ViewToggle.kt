...
fun HRKViewToggleButton(
    ...
    TextButton(
        ...
        contentPadding = HRKViewToggleDefaults.ViewToggleButtonContentPadding,
    ) {
        HRKViewToggleButtonContent(
            text = if (expanded) expandedText else compactText,
            trailingIcon = {
                Icon(
                    imageVector = if (expanded) HRKIcons.ViewDay else HRKIcons.ShortText,
 ...
 */
@Composable
private fun HRKViewToggleButtonContent(
