    ...
    Tab(
        ...
        text = {
            ...
            ProvideTextStyle(
                value = style,
                content = {
                    Box(modifier = Modifier.padding(top = HRKTabDefaults.TabTopPadding)) {
                        text()
                    }
                },
            )
 ...
 * @param tabs The tabs inside this tab row. Typically this will be multiple [HRKTab]s. Each element
