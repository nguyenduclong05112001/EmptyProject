...
import com.hrk.apps.hrkdev.core.designsystem.component.HRKBackground
import com.hrk.apps.hrkdev.core.designsystem.component.HRKFilterChip
...
class FilterChipScreenshotTests {
    ...
    fun filterChip_multipleThemes() {
        composeTestRule.captureMultiTheme("FilterChip") {
            Surface {
                HRKFilterChip(selected = false, onSelectedChange = {}) {
