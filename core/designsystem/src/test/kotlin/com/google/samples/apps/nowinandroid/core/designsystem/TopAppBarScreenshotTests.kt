...
import com.hrk.apps.hrkdev.core.designsystem.component.HRKTopAppBar
...
class TopAppBarScreenshotTests {
    ...
    @Composable
    private fun HRKTopAppBarExample() {
        HRKTopAppBar(
            titleRes = android.R.string.untitled,
            navigationIcon = HRKIcons.Search,
            navigationIconContentDescription = "Navigation icon",
            actionIcon = HRKIcons.MoreVert,
