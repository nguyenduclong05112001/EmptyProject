...
import com.hrk.apps.hrkdev.core.designsystem.component.HRKNavigationBar
import com.hrk.apps.hrkdev.core.designsystem.component.HRKNavigationBarItem
...
class NavigationScreenshotTests {
        ...
        composeTestRule.setContent {
            CompositionLocalProvider(
                ...
                DeviceConfigurationOverride(
                    ...
                    HRKTheme {
                        HRKNavigationBarExample("Looong item")
                    }
                }
            }
        }
    ...
    @Composable
    private fun HRKNavigationBarExample(label: String = "Item") {
        HRKNavigationBar {
            (0..2).forEach { index ->
                HRKNavigationBarItem(
                    icon = {
                        Icon(
                            imageVector = HRKIcons.UpcomingBorder,
                            contentDescription = "",
                        )
                    },
                    selectedIcon = {
                        Icon(
                            imageVector = HRKIcons.Upcoming,
                            contentDescription = "",
                        )
                    },
                    label = { Text(label) },
