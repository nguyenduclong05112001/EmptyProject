...
import com.hrk.apps.hrkdev.core.designsystem.component.HRKLoadingWheel
import com.hrk.apps.hrkdev.core.designsystem.component.HRKOverlayLoadingWheel
...
class LoadingWheelScreenshotTests {
    ...
    fun loadingWheel_multipleThemes() {
        composeTestRule.captureMultiTheme("LoadingWheel") {
            Surface {
                HRKLoadingWheel(contentDesc = "test")
            }
        }
    }
    ...
    fun overlayLoadingWheel_multipleThemes() {
        composeTestRule.captureMultiTheme("LoadingWheel", "OverlayLoadingWheel") {
            Surface {
                HRKOverlayLoadingWheel(contentDesc = "test")
            }
        }
    }
